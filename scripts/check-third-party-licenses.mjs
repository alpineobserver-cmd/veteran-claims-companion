...
const reviewedExceptions=new Set(["CC-BY-4.0","LGPL-3.0-or-later","Apache-2.0 AND LGPL-3.0-or-later","Apache-2.0 AND LGPL-3.0-or-later AND MIT","(AFL-2.1 OR BSD-3-Clause)"]);
...
const requiredNoticeTokens=["caniuse-lite","CC-BY-4.0","libvips","LGPL-3.0-or-later","Lucide","ISC","json-schema","BSD-3-Clause","eCFR","VA forms"];
