...
| `Claim.draftData` | Restricted questionnaire, timeline, statement, evidence-link, linked-record citation, buddy-statement, and package state | Exported; deleted with workspace/account |
