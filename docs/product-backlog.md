...
- [ ] **SEC-008 · P0 · [Partially completed]** — Provide complete user data export and account deletion controls, including clear treatment of backups and audit records. Whole-account deletion covers active database records and stored objects; a complete portable export, deletion receipt/reconciliation, and approved backup/audit-record treatment remain.
