...
export default function ChangeLogPage(){return <AppShell current="changelog"><div className="change-wrap">
  ...
  <div className="change-note"><Info size={17}/><p>This history records changes to Veteran Claims Companion—not changes made by VA itself. Regulatory and form updates include official source links when available.</p></div>
