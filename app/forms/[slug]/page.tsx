...
import { formProvenance } from "@/lib/content-provenance";
import "../forms.css";
...
export default async function FormPage({params}:{params:Promise<{slug:string}>}){
  ...
  return <AppShell current="forms"><div className="form-detail">
    ...
    <footer className="disclaimer">Debrief is an independent educational resource and is not affiliated with the U.S. Department of Veterans Affairs or Department of Defense.</footer>
  </div></AppShell>
}
