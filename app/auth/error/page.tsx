...
const errorMessages:Record<string,{title:string;message:string;next:string}>={
  ...
  MfaRequired:{title:"Google did not confirm a strong second factor.",message:"Debrief requires Google to report multi-factor authentication, a passkey, or a hardware security key before opening the account.",next:"Turn on Google 2-Step Verification and sign in again using a passkey, security key, or another Google-approved second factor."},
