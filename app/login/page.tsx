...
export const metadata:Metadata={title:"Sign in",description:"Sign in to open a private Debrief workspace and save your case progress."};
...
export default async function Login({searchParams}:{searchParams:Promise<{redirectTo?:string;retry?:string}>}){
  ...
  return <main className="login-screen">
    ...
    <section className="login-card">
      ...
      <span className="login-kicker">Private Debrief workspace</span>
      <h1>Sign in before adding case details.</h1>
      <p>New accounts begin with a clean service and health intake. Returning users resume saved work from their case overview.</p>
