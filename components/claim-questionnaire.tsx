...
import { conditionPrompts, factRows, initialAnswers as initial, qualityFindings, statementGaps, suggestedTimeline, type Answers, type EvidenceMap, type StatementField, type TimelineEvent } from "@/lib/claim-builder-intelligence";
